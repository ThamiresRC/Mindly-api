-- PACIENTES
INSERT INTO pacientes (nome, email, senha, telefone, idade, observacao)
VALUES ('Ana Silva', 'ana@mindly.com', '123456', '11999990001', 25, 'Ansiosa com o trabalho');

INSERT INTO pacientes (nome, email, senha, telefone, idade, observacao)
VALUES ('Bruno Souza', 'bruno@mindly.com', '123456', '11999990002', 30, 'Dificuldade para dormir');

INSERT INTO pacientes (nome, email, senha, telefone, idade, observacao)
VALUES ('Carla Lima', 'carla@mindly.com', '123456', '11999990003', 22, 'Crises de choro frequentes');

INSERT INTO pacientes (nome, email, senha, telefone, idade, observacao)
VALUES ('Diego Santos', 'diego@mindly.com', '123456', '11999990004', 28, 'Relata muita pressão no trabalho');

INSERT INTO pacientes (nome, email, senha, telefone, idade, observacao)
VALUES ('Fernanda Alves', 'fernanda@mindly.com', '123456', '11999990005', 32, 'Dificuldade de foco');
